import { LoggerFactory } from "@paybilldev/logger";
import { type LoggerOptions } from "@paybilldev/logger";
import { Logger } from "@paybilldev/logger";
...
describe("LoggerFactory", () => {
	...
	test("should get default  logger config", () => {
		...
		expect(config.logger.default.fileLogName).toEqual("app.log");
		...
		expect(config.logger.clients.coreLogger.fileLogName).toEqual("core.log");
	});
});
