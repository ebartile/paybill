...
export type LoggerFormat<ExtraInfoOptions = LoggerInfo> = (
	info: ExtraInfoOptions,
	logger?: ILogger,
) => string | Record<any, any> | Buffer;
...
export interface ConfigLoggerOptions extends LoggerOptions {
	/**
	 * Output transport
	 */
