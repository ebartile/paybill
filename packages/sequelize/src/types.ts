...
export type ModelCreateWithAssociationsEventType =
	"afterCreateWithAssociations";
export type ModelUpdateWithAssociationsEventType =
...
export type ModelBulkDestroyEvnetType =
	| "beforeBulkDestroy"
	| "afterBulkDestroy";

export type ModelValidateEventTypes =
	| ModelValidateEventType
	| `${CollectionNameType}.${ModelValidateEventType}`;
export type ModelCreateEventTypes =
	| ModelCreateEventType
	| `${CollectionNameType}.${ModelCreateEventType}`;
export type ModelUpdateEventTypes =
	| ModelUpdateEventType
	| `${CollectionNameType}.${ModelUpdateEventType}`;
export type ModelSaveEventTypes =
	| ModelSaveEventType
	| `${CollectionNameType}.${ModelSaveEventType}`;
export type ModelDestroyEventTypes =
	| ModelDestroyEventType
	| `${CollectionNameType}.${ModelDestroyEventType}`;
...
export type ModelBulkCreateEvnetTypes =
	| ModelBulkCreateEvnetType
	| `${CollectionNameType}.${ModelBulkCreateEvnetType}`;
export type ModelBulkUpdateEvnetTypes =
	| ModelBulkUpdateEvnetType
	| `${CollectionNameType}.${ModelBulkUpdateEvnetType}`;
