...
import { IS_PROD, LOCAL_STORAGE_KEYS } from '~/common'
import { getSharedTelemetryData } from '~/common/telemetry-utils'
...
export function useTelemetryCookie({
  ...
  useEffect(() => {
    ...
    const cookieOptions = IS_PROD ? 'path=/; domain=paybill.dev' : 'path=/'
