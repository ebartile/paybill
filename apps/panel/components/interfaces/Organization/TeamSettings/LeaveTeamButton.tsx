...
import { ButtonTooltip } from '~/components/ui'
...
export const LeaveTeamButton = () => {
  ...
  const currentUserMember = members?.find((member) => member.paybill_id === profile?.paybill_id)
  ...
  const leaveTeam = async () => {
    ...
    setIsLeaving(true)
    deleteMember({ slug, paybillId: profile.paybill_id })
  }
