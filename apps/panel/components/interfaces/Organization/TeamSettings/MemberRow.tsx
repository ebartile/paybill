...
import PartnerIcon from '~/components/ui/Icon/PartnerIcon'
...
export const MemberRow = ({ member }: MemberRowProps) => {
  ...
  const profileImageUrl =
    isInvitedUser || isEmailUser ? undefined : `https://github.com/${member.username}.png?size=96`
      ...
      <Table.td>
        <div className="flex items-center gap-x-4">
          ...
          <div className="flex item-center gap-x-2">
            ...
            {member.paybill_id === profile?.paybill_id && <Badge color="scale">You</Badge>}
          </div>
