...
import { useIsLoggedIn, useSignOut, useUser } from 'common'
...
import type { ResponseError, Profile } from 'types'
...
export const ProfileProvider = ({ children }: PropsWithChildren<{}>) => {
  ...
  const value = useMemo(() => {
    ...
    const profileImageUrl = isGHUser ? `https://github.com/${profile.username}.png?size=96` : undefined
