...
export interface paths {
  '/platform/auth/{ref}/config': {
    ...
    /** Gets Paybill config */
    get: operations['PaybillConfigController_getPaybillConfig']
    put?: never
    post?: never
    delete?: never
    options?: never
    head?: never
    /** Updates Paybill config */
    patch: operations['PaybillConfigController_updatePaybillConfig']
    trace?: never
  }
  '/platform/auth/{ref}/config/hooks': {
    ...
    options?: never
    head?: never
    /** Updates Paybill config hooks */
    patch: operations['PaybillConfigController_updatePaybillConfigHooks']
    trace?: never
  }
  ...
  '/platform/organizations/{slug}/members/{paybill_id}': {
    parameters: {
      query?: never
      header?: never
      path?: never
...
export interface components {
  schemas: {
    ...
    GetSubscriptionResponse: {
      ...
      /** @enum {string} */
      billing_partner?: 'aws' | 'vercel_marketplace'
      billing_via_partner: boolean
...
export interface operations {
  PaybillConfigController_getPaybillConfig: {
    parameters: {
      query?: never
      header?: never
      path: {
    ...
    responses: {
      200: {
        ...
        content: {
          'application/json': components['schemas']['PaybillConfigResponse']
        }
      }
      /** @description Failed to retrieve Paybill config */
      500: {
        headers: {
          [name: string]: unknown
        }
  ...
  PaybillConfigController_updatePaybillConfig: {
    parameters: {
      query?: never
      header?: never
      path: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['UpdatePaybillConfigBody']
      }
    }
    responses: {
      200: {
      ...
      /** @description Failed to update Paybill config */
      500: {
        headers: {
          [name: string]: unknown
        }
  ...
  PaybillConfigController_updatePaybillConfigHooks: {
    parameters: {
      query?: never
      header?: never
      path: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['UpdatePaybillConfigHooksBody']
      }
    }
    responses: {
      200: {
      ...
      /** @description Failed to update Paybill config hooks */
      500: {
        headers: {
          [name: string]: unknown
        }
  ...
  TemplateController_getTemplate: {
    ...
    responses: {
      ...
      /** @description Failed to retrieve Paybill template */
      500: {
        headers: {
          [name: string]: unknown
        }
