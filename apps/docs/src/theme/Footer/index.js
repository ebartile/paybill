            ...
            {logo && (
              <>
                ...
                <div className="footer__socials" style={{ marginTop: '1rem', display: 'flex', gap: '1rem' }}>
                  ...
                  <a href="https://paybill.dev/discord" target="_blank" rel="noopener noreferrer">
                    <ThemedImage
                      sources={{
                        light: '/img/social/discord-icon.svg',
                        dark: '/img/social/discord-icon-white.svg'
                      }}
                      alt="Discord"
                      style={{ width: '24px', height: '24px', objectFit: 'contain', boxShadow: 'none', borderRadius: '0' }}
                    />
                  ...
                  <a href="https://www.linkedin.com/company/paybilldev" target="_blank" rel="noopener noreferrer">
                    <ThemedImage
                      sources={{
                        light: '/img/social/linkedin-icon.svg',
                        dark: '/img/social/linkedin-icon-white.svg'
                      }}
                      alt="Linkedin"
                      style={{ width: '24px', height: '24px', objectFit: 'contain', boxShadow: 'none', borderRadius: '0' }}
                    />
